...
#ifndef MYPROXY_HTTP_SERVER_CONNECTION_H
#define MYPROXY_HTTP_SERVER_CONNECTION_H
...
public:
    using pointer = std::shared_ptr <basic_http_connection<SocketType>>;
...
#endif //MYPROXY_HTTP_SERVER_CONNECTION_H
